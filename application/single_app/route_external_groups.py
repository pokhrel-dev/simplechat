# route_external_groups.py

from config import *
from functions_authentication import *
from functions_group import *

def register_route_external_groups(app):
    """
    Register all group-related API endpoints under '/external/groups/...'
    """

    @app.route("/external/groups/discover", methods=["GET"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_discover_groups():
        """
        GET /external/groups/discover?search=<term>&showAll=<true|false>
    ...
    @app.route("/external/groups", methods=["GET"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_list_groups():
        """
    ...
    @app.route("/external/groups", methods=["POST"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_create_group():
        """
        POST /external/groups
    ...
    @app.route("/external/groups/<group_id>", methods=["GET"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_get_group_details(group_id):
        """
        GET /external/groups/<group_id>
    ...
    @app.route("/external/groups/<group_id>", methods=["DELETE"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_delete_group(group_id):
        """
        DELETE /external/groups/<group_id>
    ...
    @app.route("/external/groups/<group_id>", methods=["PATCH", "PUT"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_update_group(group_id):
        """
        PATCH /external/groups/<group_id> or PUT /external/groups/<group_id>
    ...
    @app.route("/external/groups/setActive", methods=["PATCH"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_set_active_group():
        """
        PATCH /external/groups/setActive
    ...
    @app.route("/external/groups/<group_id>/requests", methods=["POST"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_request_to_join(group_id):
        """
        POST /external/groups/<group_id>/requests
    ...
    @app.route("/external/groups/<group_id>/requests", methods=["GET"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_view_pending_requests(group_id):
        """
        GET /external/groups/<group_id>/requests
    ...
    @app.route("/external/groups/<group_id>/requests/<request_id>", methods=["PATCH"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_approve_reject_request(group_id, request_id):
        """
        PATCH /external/groups/<group_id>/requests/<request_id>
    ...
    @app.route("/external/groups/<group_id>/members", methods=["POST"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_add_member_directly(group_id):
        """
        POST /external/groups/<group_id>/members
    ...
    @app.route("/external/groups/<group_id>/members/<member_id>", methods=["DELETE"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_remove_member(group_id, member_id):
        """
        DELETE /external/groups/<group_id>/members/<member_id>
    ...
    @app.route("/external/groups/<group_id>/members/<member_id>", methods=["PATCH"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_update_member_role(group_id, member_id):
        """
        PATCH /external/groups/<group_id>/members/<member_id>
    ...
    @app.route("/external/groups/<group_id>/members", methods=["GET"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_view_group_members(group_id):
        """
        GET /external/groups/<group_id>/members?search=<term>&role=<role>
    ...
    @app.route("/external/groups/<group_id>/transferOwnership", methods=["PATCH"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_transfer_ownership(group_id):
        """
        PATCH /external/groups/<group_id>/transferOwnership
    ...
    @app.route("/external/groups/<group_id>/fileCount", methods=["GET"])
    @accesstoken_required
    @enabled_required("enable_group_workspaces")
    def external_get_group_file_count(group_id):
        """
        GET /external/groups/<group_id>/fileCount
